#!/usr/bin/env node
/* eslint-disable @typescript-eslint/no-require-imports -- Node hook runtime uses CommonJS */
/**
...
function getPluginRoot() {
  const cursorBundleRoot = path.resolve(__dirname, '..');
  const bundledHooks = path.join(cursorBundleRoot, 'scripts', 'hooks');
  if (fs.existsSync(bundledHooks)) {
    return cursorBundleRoot;
  }
